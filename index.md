...
## Experience
### Medior Java Developer — Yonder
*01/2025 – Present · Iasi, Romania · Healthcare*
{: .date-range}

- Develop new features on the monolith, that usually renders chromium service-application components(developed on microservice space)
- Develop new features and functionalities on the microservice space
- Integrate AI tools within our application
- Developed async events libraries to enable every module to communicate in a distributed way. Security and privacy guaranteed by topic hierarchy and Keycloak custom authenticator as OAuth service for RabbitMQ.

**Tech:** Java 8, 11 & 17, Spring Boot 3.x - 4.x, Gradle, RabbitMQ, Keycloak,  PostgreSQL, 
**Tools:** IntelliJ Idea with Junie, Claude Code; GitLab Pipelines,Artifactory, OpenAPI, Splunk, Cloud on premise maintainable with spring-admin;

---
### Medior Java Developer — 8x8 International
*08/2023 – 12/2024 · Remote, Romania · Virtual Contact Center*
{: .date-range}
...
| Language | Level |
|---|---|
| **English** | B2 (Upper Intermediate) - officialy. But I've used it daily for most of my jobs|
...
<div class="resume-footer">
  ...
  <p class="print-note"><a href="https://github.com/mititeluteofil/presentation">View source on GitHub</a></p>
</div>
